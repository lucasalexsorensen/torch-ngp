...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "path",
        type=str,
        help="root directory to the LLFF dataset (contains images/ and pose_bounds.npy)",
    )
    ...
    images = [f for f in images if not os.path.basename(f).startswith("dynamic_mask_")]
